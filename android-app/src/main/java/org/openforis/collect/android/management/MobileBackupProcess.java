 ...
 *
 */
public class MobileBackupProcess extends AbstractProcess<Void, DataExportStatus> {

	private static Log LOG = LogFactory.getLog(MobileBackupProcess.class);

	private static final String FILE_NAME = "data.zip";

	private MobileRecordManager recordManager;
	private MobileSurveyManager surveyManager;
	...
	public MobileBackupProcess(MobileSurveyManager surveyManager, MobileRecordManager recordManager, DataMarshaller dataMarshaller, File directory,
